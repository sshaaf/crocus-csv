...
public class CSVFileImpl extends File implements CSVFile {
     ...
     */
    public CSVFileImpl(String fileName, char deliminator) throws FileNotFoundException {
        super(fileName);
    ...
    public synchronized void write() throws IOException {
        for (int rowIndex = 0;rowIndex < getCSVRecordManager().getRowCount();rowIndex++) {
            p.println(getCSVRecordManager().getRow(rowIndex).toString(this.deliminator));
        }
    }
