...
import net.sf.crocus.csv.record.CSVRecordManager;
...
public class CSVSingleFileInterface implements CSVReadInterface {
	...
	public AbstractCSVRecordManager read() throws IOException,
		...
		CSVParser parser = new CSVParserImpl(CSVConstants.COMMA);
		reader = new CSVBufferedReaderImpl(new FileReader((File)csvFile), parser, csvFile.getCSVRecordManager());
